...
function beta_bar(){
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div id="viewport-switch" class="btn-group btn-group-xs" role="group">
        <button data-viewport="mobile" type="button" class="btn btn-default">Mobile</button>
        <button data-viewport="tablet" type="button" class="btn btn-default">Tablet</button>
        <button data-viewport="web-small" type="button" class="btn btn-default">Web / Small</button>
        <button data-viewport="web-large" type="button" class="btn btn-default">Web / Large</button>
      </div>
    </div>
  </div>
EOF;
